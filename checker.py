...
# ⚡ Bolt: Cache VideoFileClip properties to prevent redundant ffprobe calls.
# Instantiating VideoFileClip triggers an expensive ffprobe subprocess call.
# By caching the result, we avoid parsing the same video multiple times
# during validation, reducing overhead.
